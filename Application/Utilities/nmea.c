...
// methods
static float 	distance_between (float lat1, float long1, float lat2, float long2, float units_per_meter);
static float	initial_course(float lat1, float long1, float lat2, float long2);
static int		_dehex(char a);
static float	_decimal(char* s);
...
float nmea_gprmc_distance_to(float latitude, float longitude, float unit) {
...
float nmea_gprmc_course_to(float latitude, float longitude) {
...
//float nmea_gprmc_rel_course_to(float latitude, float longitude) {
...
float nmea_distance_between (float lat1, float long1, float lat2, float long2, float units_per_meter) {
...
float nmea_initial_course (float lat1, float long1, float lat2, float long2) {
